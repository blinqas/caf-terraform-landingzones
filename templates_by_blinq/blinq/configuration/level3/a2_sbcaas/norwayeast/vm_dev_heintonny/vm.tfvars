...
virtual_machines = {
  vm_dev_heintonny = {
    resource_group_key = "rg_dev_heintonny"
    ...
    networking_interfaces = {
      ...
      nic0 = {
        ...
        lz_key               = "vnet_a2_sbcaas_norwayeast"
        vnet_key             = "vnet_a2_sbcaas_norwayeast"
        subnet_key           = "public_sip"
        primary              = true
        name                 = "0-dev_heintonny"
        ...
        internal_dns_name_label       = "dev_heintonny-nic0"
        private_ip_address_allocation = "Static"
        private_ip_address_version    = "IPv4"
        private_ip_address            = "10.21.2.70"

        # public_ip_address_key = "pip_sip1_dev_heintonny"
