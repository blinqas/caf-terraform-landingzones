...
rover \
  ...
  -var-folder /tf/caf/configuration/level2/connectivity/norwayeast/virtual_hub_services/firewall_policies \
  ...
  -level level2 \
  -w tfstate \
  -p ${TF_DATA_DIR}/connectivity_firewall_policies.tfstate.tfplan \
  -a plan
