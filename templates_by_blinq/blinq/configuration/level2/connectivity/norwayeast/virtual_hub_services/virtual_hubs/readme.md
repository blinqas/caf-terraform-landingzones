...
rover \
  ...
  -var-folder /tf/caf/configuration/level2/connectivity/norwayeast/virtual_hub_services/virtual_hubs \
  ...
  -level level2 \
  -w tfstate \
  -p ${TF_DATA_DIR}/connectivity_virtual_hubs_norwayeast.tfstate.tfplan \
  -a plan
