packer_build = {
  build1 = {
    packer_working_dir                               = "/tf/caf/configuration/level2/asvm/a2_sbcaas/norwayeast/shared_image_gallery/packer_files/"
    ...
    build_resource_group_key                         = "rg_build_a2_sbcaas_norwayeast" #build in existing resource group instead of temporary rg created by packer
    resource_group_key                               = "rg_sig_a2_sbcaas_norwayeast"   #for managed_image_resource_group_name
    os_type                                          = "Linux"
