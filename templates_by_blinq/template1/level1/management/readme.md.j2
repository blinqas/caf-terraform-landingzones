...
rover \
{% if "not deployed" not in ignite.global.cred_keyvaults.cred_management.stdout %}
  --impersonate-sp-from-keyvault-url {{ ignite.global.cred_keyvaults.cred_management.stdout }}.vault.azure.net \
{% endif %}
