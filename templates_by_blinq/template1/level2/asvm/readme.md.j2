...
rover \
{% if "not deployed" not in ignite.global.cred_keyvaults.cred_subscription_creation_landingzones.stdout %}
  --impersonate-sp-from-keyvault-url {{ ignite.global.cred_keyvaults.cred_subscription_creation_landingzones.stdout }}.vault.azure.net \
{% endif %}
