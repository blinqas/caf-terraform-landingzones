...
rover \
  ...
  -var-folder /tf/caf/configuration/level2/connectivity/hub_norwayeast/vnet_shared_services \
  ...
  -level level2 \
  -w tfstate \
  -p ${TF_DATA_DIR}/connectivity_vnet_shared_services_norwayeast.tfstate.tfplan \
  -a plan
