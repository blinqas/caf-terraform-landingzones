  ...
  sbc002a = {
    ...
    networking_interfaces = {
      ...
      nic0 = {
        ...
        internal_dns_name_label       = "sbc002a-nic0"
        private_ip_address_allocation = "static"
        private_ip_address_version    = "IPv4"
        private_ip_address            = "10.2.2.100"

        public_ip_address_key = "lz_sbcaas_pip_sip1_norwayeast"
      ...
      nic1 = {
        ...
        internal_dns_name_label       = "sbc002a-nic1"
        private_ip_address_allocation = "static"
        private_ip_address_version    = "IPv4"
        private_ip_address            = "10.2.2.132"

        public_ip_address_key = "lz_sbcaas_pip_media1_norwayeast"
      ...
      nic2 = {
        ...
        internal_dns_name_label       = "sbc002a-nic2"
        private_ip_address_allocation = "static"
        private_ip_address_version    = "IPv4"
        private_ip_address            = "10.2.2.164"
      ...
      nic3 = {
        ...
        internal_dns_name_label       = "sbc002a-nic3"
        private_ip_address_allocation = "static"
        private_ip_address_version    = "IPv4"
        private_ip_address            = "10.2.2.196"
  ...
  sbc002b = {
    ...
    networking_interfaces = {
      ...
      nic0 = {
        ...
        internal_dns_name_label       = "sbc002b-nic0"
        private_ip_address_allocation = "static"
        private_ip_address_version    = "IPv4"
        private_ip_address            = "10.2.2.101"

        public_ip_address_key = "lz_sbcaas_pip_sip2_norwayeast"
        # public_address_id = "/subscriptions/26fa8950-d742-4940-bfcd-56d8586b11b3/resourceGroups/bs-prod-sbcaas-re3-pip-prefixes/providers/Microsoft.Network/publicIPAddresses/20.117.217.200"
        # example with external network objects
        # subnet_id = "/subscriptions/sub-id/resourceGroups/test-manual/providers/Microsoft.Network/virtualNetworks/vnet/subnets/default"
        # We have reserved prefix 20.108.216.208/29 with 8 addresses, 4 first for SIP 4 last for RTP
      ...
      nic1 = {
        ...
        internal_dns_name_label       = "sbc002b-nic1"
        private_ip_address_allocation = "static"
        private_ip_address_version    = "IPv4"
        private_ip_address            = "10.2.2.133"

        public_ip_address_key = "lz_sbcaas_pip_media2_norwayeast"
        # public_address_id = "/subscriptions/26fa8950-d742-4940-bfcd-56d8586b11b3/resourceGroups/bs-prod-sbcaas-re3-pip-prefixes/providers/Microsoft.Network/publicIPAddresses/20.117.217.204"
        # example with external network objects
        # subnet_id = "/subscriptions/sub-id/resourceGroups/test-manual/providers/Microsoft.Network/virtualNetworks/vnet/subnets/default"
        # We have reserved prefix with 8 addresses, 4 first for SIP 4 last for Media
      ...
      nic2 = {
        ...
        internal_dns_name_label       = "sbc002b-nic2"
        private_ip_address_allocation = "static"
        private_ip_address_version    = "IPv4"
        private_ip_address            = "10.2.2.165"
      ...
      nic3 = {
        ...
        internal_dns_name_label       = "sbc002b-nic3"
        private_ip_address_allocation = "static"
        private_ip_address_version    = "IPv4"
        private_ip_address            = "10.2.2.197"
    ...
    virtual_machine_settings = {
      ...
      linux = {
        ...
        os_disk = {
          name                    = "sbc002b-os-norwayeast"
          caching                 = "ReadWrite"
          storage_account_type    = "StandardSSD_LRS"
          disk_encryption_set_key = "deskey_set2"
        }
